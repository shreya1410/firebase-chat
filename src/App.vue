...
'message') ">
      <div class="message-inner">
        ...
        <div class="username">{{message.content}}</div>
      </div>
  ...
  <footer>
    <form @submit.prevent="SendMessage">
      <input type="text"  v-model="inputMessage" placeholder="write here.." />
...
export default {
  ...
  setup(){
    ...
    return {
      inputUsername,Login,state , inputMessage,SendMessage,Logout
    }
  }
